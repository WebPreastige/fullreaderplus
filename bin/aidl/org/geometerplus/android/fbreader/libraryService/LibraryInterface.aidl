...
interface LibraryInterface {
	...
	List<String> booksForLocation(in String location);
	...
	String getRecentBookByTitleAndLocation(in String title, in String location);
	...
	List<String> invisibleQuotes(in String book);
	List<String> quotes(in long fromId, in int limitCount);
	List<String> quotesForBook(in String book, in long fromId, in int limitCount);
	String saveQuote(in String quote);
	void deleteQuote(in String quote);
}
