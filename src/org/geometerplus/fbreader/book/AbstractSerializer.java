...
abstract class AbstractSerializer {
    ...
    public abstract String serialize(ITextMarker bookmark);
    public abstract ITextMarker deserializeTextMarker(String xml);
    public abstract Quote deserializeQuote(String xml);
