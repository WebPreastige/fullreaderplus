...
public final class Quote extends ZLTextFixedPosition implements ITextMarker{
	...
	Quote(long id, long bookId, String bookTitle, String text, Date creationDate, Date modificationDate, Date accessDate, int accessCount, String modelId, int paragraphIndex, int elementIndex, int charIndex, boolean isVisible) {
	...
	public Quote(int pIndex, int eIndex, int cIndex, Book book, String modelId, ZLTextWordCursor cursor, int maxLength, boolean isVisible) {
		this(book, modelId, cursor, createQuoteText(cursor, maxLength), isVisible);
	}

	public Quote(Book book, String modelId, ZLTextPosition position, String text, boolean isVisible) {
		super(position);
	...
	public static class ByTimeComparator implements Comparator<Quote> {
		public int compare(Quote bm0, Quote bm1) {
	...
	private static String createQuoteText(ZLTextWordCursor cursor, int maxWords) {
