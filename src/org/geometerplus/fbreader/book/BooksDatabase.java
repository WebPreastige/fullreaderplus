...
public abstract class BooksDatabase {
    ...
    protected Quote createQuote(long id, long bookId, String bookTitle, String text, Date creationDate, Date modificationDate, Date accessDate, int accessCounter, String modelId, int paragraphIndex, int wordIndex, int charIndex, boolean isVisible) {
        return new Quote(id, bookId, bookTitle, text, creationDate, modificationDate, accessDate, accessCounter, modelId, paragraphIndex, wordIndex, charIndex, isVisible);
    }
    ...
    protected abstract List<Quote> loadInvisibleQuotes(long bookId);
    protected abstract List<Quote> loadVisibleQuotes(long fromId, int limitCount);
    protected abstract List<Quote> loadVisibleQuotes(long bookId, long fromId, int limitCount);
    protected abstract long saveQuote(Quote quote);
    protected abstract void deleteQuote(Quote quote);
