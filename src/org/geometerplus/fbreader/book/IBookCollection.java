...
public interface IBookCollection {
	...
	List<Book>	booksForLocation(String location);
	...
	void deleteQuotesTextMarker(ITextMarker quote);
	void deleteBookmarkTextMarker(ITextMarker bookmark);
    List<Quote> quotes(long fromId, int limitCount);
    List<Quote> quotesForBook(Book book, long fromId, int limitCount);
    List<Quote> invisibleQuotes(Book book);
