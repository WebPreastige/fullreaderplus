...
public interface ActionCode {
	...
	String SHOW_COLOR_PREFERENCES = "colorPreferences";
	String SHOW_BOOK_INFO = "bookInfo";
	String SHOW_TOC = "toc";
	String SHOW_BOOKMARKS = "bookmarks";
    String SHOW_QUOTES = "quotes";
	String SHOW_NETWORK_LIBRARY = "networkLibrary";
	String SHOW_COLOR_MARKS = "menuColorMarks";
	
	String NEXT_BOOK = "nextBook";
	String PREVIOUS_BOOK = "previousBook";
    ...
    String SELECTION_QUOTES = "selectionQuotes";
    
    String SELECTION_DICTIONARY = "openDictionary";
    String SELECTION_MARK_COLOR = "markColor";
    
    String FULLSCREEN_MODE = "fullScreen";
}
