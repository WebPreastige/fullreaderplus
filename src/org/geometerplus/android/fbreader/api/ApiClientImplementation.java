...
public class ApiClientImplementation implements ServiceConnection, Api, ApiMethods {
	...
	private static final String ACTION_API = "android.reader.action.API";
	static final String ACTION_API_CALLBACK = "android.reader.action.API_CALLBACK";
	...
	private synchronized void checkConnection() throws ApiException {
		if (myInterface == null) {
			throw new ApiException("Not connected to Reader");
		}
	}
	...
	public String getReaderVersion() throws ApiException {
