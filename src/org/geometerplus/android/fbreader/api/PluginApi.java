...
public abstract class PluginApi {
	public static final String ACTION_REGISTER = "android.reader.action.plugin.REGISTER";
	public static final String ACTION_RUN = "android.reader.action.plugin.RUN";
