...
public class NetworkLibraryPrimaryActivity extends NetworkLibraryActivity {
	...
	public void onResume() {
		super.onResume();
		Log.d("ON RESUME", "NETWORK LIBRARY");
			...
			public void run() {
				switch (code) {
					...
					case Found:
						...
						break;
					case NotFound:
						UIUtil.showErrorMessage(NetworkLibraryPrimaryActivity.this, "emptyNetworkSearchResults");
						getListView().invalidateViews();
						break;
					case EmptyCatalog:
						UIUtil.showErrorMessage(NetworkLibraryPrimaryActivity.this, "emptyCatalog");
						break;
					case NetworkError:
						UIUtil.showMessageText(NetworkLibraryPrimaryActivity.this, (String)params[0]);
						break;
				}
			}
		});
		...
		final DialogInterface.OnClickListener listener = new DialogInterface.OnClickListener() {
			public void onClick(DialogInterface dialog, int which) {
				if (which == DialogInterface.BUTTON_POSITIVE) {
					Util.initLibrary(NetworkLibraryPrimaryActivity.this);
				} else {
					finish();
				}
			}
