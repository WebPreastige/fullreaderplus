...
public abstract class Util implements UserRegistrationConstants {
	static final String AUTHORIZATION_ACTION = "android.reader.action.network.AUTHORIZATION";
	static final String SIGNIN_ACTION = "android.reader.action.network.SIGNIN";

	public static final String ADD_CATALOG_ACTION = "android.reader.action.ADD_OPDS_CATALOG";
	public static final String ADD_CATALOG_URL_ACTION = "android.reader.action.ADD_OPDS_CATALOG_URL";
	public static final String EDIT_CATALOG_ACTION = "android.reader.action.EDIT_OPDS_CATALOG";
	...
	public static void runAuthenticationDialog(Activity activity, INetworkLink link, Runnable onSuccess) {
		...
		Toast.makeText(activity, "ХУЙ!", Toast.LENGTH_LONG);
	}
