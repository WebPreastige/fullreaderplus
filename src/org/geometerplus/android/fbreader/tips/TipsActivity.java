...
public class TipsActivity extends Activity {
	public static final String INITIALIZE_ACTION = "android.reader.action.tips.INITIALIZE";
	public static final String SHOW_TIP_ACTION = "android.reader.action.tips.SHOW_TIP";
