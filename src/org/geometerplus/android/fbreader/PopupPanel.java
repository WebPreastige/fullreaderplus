...
abstract class PopupPanel extends ZLApplication.PopupPanel {
	...
	private volatile FullReaderActivity myActivity;
	private volatile RelativeLayout myRoot;

	PopupPanel(ReaderApp fbReader) {
		super(fbReader);
	}

	protected final ReaderApp getReader() {
		return (ReaderApp)Application;
	}
	...
	public void setPanelInfo(FullReaderActivity activity, RelativeLayout root) {
		myActivity = activity;
		myRoot = root;
	}

	public abstract void createControlPanel(FullReaderActivity activity, RelativeLayout root);
}
