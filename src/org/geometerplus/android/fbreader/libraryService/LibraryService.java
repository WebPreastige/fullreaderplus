...
public class LibraryService extends Service {
	...
	public final class LibraryImplementation extends LibraryInterface.Stub {
		...
		public List<String> booksForLocation(String location) {
			return SerializerUtil.serializeBookList(myCollection.booksForLocation(location));
		}
		...
		public String getRecentBookByTitleAndLocation(String title, String location){
			return SerializerUtil.serialize(myCollection.getRecentBookByTitleAndLocation(title, location));
		}
		...
		public List<String> getBooksByTitle(String title){
			List<Book> books = myCollection.getBooksByTitle(title);
			return SerializerUtil.serializeBookList(books);
		}
        ...
        public List<String> invisibleQuotes(String book) {
            return SerializerUtil.serializeQuoteList(
                myCollection.invisibleQuotes(SerializerUtil.deserializeBook(book))
            );
        }

        public List<String> quotes(long fromId, int limitCount) {
            return SerializerUtil.serializeQuoteList(myCollection.quotes(fromId, limitCount));
        }

        public List<String> quotesForBook(String book, long fromId, int limitCount) {
            return SerializerUtil.serializeQuoteList(myCollection.quotesForBook(
                SerializerUtil.deserializeBook(book), fromId, limitCount
            ));
        }

        public String saveQuote(String serialized) {
            final Quote quote = (Quote) SerializerUtil.deserializeQuote(serialized);
            myCollection.saveQuote(quote);
            return SerializerUtil.serialize(quote);
        }

        public void deleteQuote(String serialized) {
            myCollection.deleteQuotesTextMarker(SerializerUtil.deserializeQuote(serialized));
        }
        
        public void deleteBookmark(String serialized) {
            myCollection.deleteBookmarkTextMarker(SerializerUtil.deserializeBookmark(serialized));
        }
    }
