...
public class SelectionFbShareAction extends FBAndroidAction {
	...
	SelectionFbShareAction(FullReaderActivity baseActivity, ReaderApp fbreader) {
		super(baseActivity, fbreader);
	}

	@Override
	protected void run(Object ... params) {
		text = ReaderApp.getTextView().getSelectedText();
		final String title = ReaderApp.Model.Book.getTitle();
		...
		((FullReaderActivity)BaseActivity).shareFbQuote(text);
