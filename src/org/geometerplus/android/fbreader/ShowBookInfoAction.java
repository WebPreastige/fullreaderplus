...
class ShowBookInfoAction extends FBAndroidAction {
	ShowBookInfoAction(FullReaderActivity baseActivity, ReaderApp fbreader) {
	...
	protected void run(Object ... params) {
		OrientationUtil.startActivityForResult(
			...
			new Intent(BaseActivity.getApplicationContext(), BookInfoActivity.class)
				.putExtra(FullReaderActivity.BOOK_KEY, SerializerUtil.serialize(ReaderApp.Model.Book))
				.putExtra(BookInfoActivity.FROM_READING_MODE_KEY, true),
			FullReaderActivity.REQUEST_BOOK_INFO
		);
	}
}
